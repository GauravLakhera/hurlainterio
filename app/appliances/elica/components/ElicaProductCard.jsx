...
export default function ElicaProductCard({ product, viewMode, onViewDetail }) {
    ...
    <div className="bg-white rounded-lg shadow-md hover:shadow-xl transition-all duration-300 overflow-hidden group">
      ...
      <div className="p-5">
        ...
        <div className="grid grid-cols-2 gap-2">
          ...
          <Link href="/contact">
            <button className="bg-blue-600 hover:bg-blue-700 text-white py-2 px-3 rounded-lg text-sm font-medium transition-colors w-full">
              Buy Now
            </button>
          </Link>
        </div>
